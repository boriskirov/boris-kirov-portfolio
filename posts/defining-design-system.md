...
> [Human body](https://www.livescience.com/37009-human-body.html)
>
...
> [Body systems](https://biologydictionary.net/body-systems/)
>
...
![Defining Design system](../../defining-design-systems-app-2.jpeg)
...
- a set of connected things or devices that operate together [Cambridge Dictionary](https://dictionary.cambridge.org/dictionary/english/system)
- a group of interacting or interrelated entities that form a unified whole [Wikipedia](https://en.wikipedia.org/wiki/System)
- a regularly interacting or interdependent group of items forming a unified whole [Merriam Webster Dictionary](https://www.merriam-webster.com/dictionary/system)
- an assemblage or combination of things or parts forming a complex or unitary whole [Dictionary.com](https://www.dictionary.com/browse/system)
- a cohesive conglomeration of interrelated and interdependent parts that can be natural or human-made [Wikipedia System theory definition](https://en.wikipedia.org/wiki/Systems_theory)
...
![Defining Design system](../../defining-design-systems-app-3.jpeg)
...
1. Is the Sketch library file the design system?
2. Is the storybook documentation the design system?
3. Is the docz.site markdown documentation the design system?
4. Should we include the brand guidelines and marketing statements in the system too?

Then by looking for the answer, more questions come up:

1. Who are the people responsible for it?
2. Is the front-end team the one that is responsible for keeping the documentation of the design system up to date?
3. Are the designers the ones responsible for the component kit which is actually the design system?
4. Where does a product owner or any other product member fit in the design system?
5. Does the business and management have a word in that design system?
6. Is that only related to components and visual assets, what about non quantitative items?
7. Can we measure this? How?
...
🏴‍☠️ Illustrations done by [Pirate Jazzy](https://www.instagram.com/piratejazzy/)
