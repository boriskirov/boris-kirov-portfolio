...
export const NAV = [
  ...
  },
  {
    ...
    children: [
      {
        label: "Log Processing UX Design in Elastic Streams",
        href: "https://www.elastic.co/observability-labs/blog/designing-log-processing-ux-for-streams",
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "How Elastic Streams Simplifies Log Data Management",
        href: "https://www.meetup.com/elasticsearch-bulgaria-user-group/events/313523239/?eventOrigin=group_past_events",
        target: "_blank",
      },
    ],
