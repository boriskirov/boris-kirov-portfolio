              ...
              <section>
                ...
                <details className="dicCard">
                  ...
                  <p>
                    ...
                    made to suit their needs. Human-centered design is all about
                    building a deep empathy with the people you’re designing
                    for; generating tons of ideas; building a bunch of
                    prototypes; sharing what you’ve made with the people you’re
                    designing for; and eventually putting your innovative new
                ...
                <details className="dicCard">
                  ...
                  <p>
                    Modular design is a design approach that creates things out
                    of independent parts with standard interfaces. This allows
                    designs to be customized, upgraded, repaired and for parts
                    to be. A well known example of modular design are LEGO
                    plastic construction toys and Ikea the Scandinavian-founded,
                    worldwide furniture store.
                  </p>
                </details>
                ...
                <details className="dicCard">
                  ...
                  <p>
                    ...
                    sounds like an obvious choice but can be problematic when
                    your goal is narrow such that you miss the bigger picture by
                    doing things the easy way. The following are illustrative
                ...
                <details className="dicCard">
                  ...
                  <p>
                    ...
                    with preventing human error through design. Pokayoke applies
                    to both the design of production techniques and end products
                    for consumers (e.g. Microwave doors typically can't be open
                ...
                <details className="dicCard">
                  ...
                  <p>
                    ...
                    when they aren't surprising. That is to say, that when a
                    user first sees your design they aren't surprised by how it
                    works. This lowers the learning curve for users and tends to
                    generate positive emotions. When users need to invest in
                    learning a design, they may feel that they are bending to
                    technology as opposed to technology bending to them.
                  </p>
                </details>
              </section>
            </div>
