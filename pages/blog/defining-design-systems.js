          ...
          <div className={`${utilStyles.mainWrapper}`}>
            ...
            <main className={`${utilStyles.innerWrapper}`}>
              ...
              <div className={`${utilStyles.contentWrapper}`}>
                <section>
                  <blockquote>
                    System is “the whole creation, the universe,” from Late
                    Latin systema “an arrangement, system,” from Greek systema
                    “organized whole, a whole compounded of parts”.
                  </blockquote>
                  <p>
                    <span className={`${utilStyles.dropCap}`}>D</span> esign
                    systems have been around for quite some time now.
                    Organizations keep incorporating them in order to be
                    relevant and quick into the dynamic and fierce digital
                    world. Businesses keep growing and expanding into different
                    mediums, devices and ways to communicate with their users
                    and customers, so the systems are here to help bridge those
                    gaps in the most efficient way possible.
                  </p>
                  <p>
                    In this post, I will try to give a definition of a design
                    system and how the systematic approach is connected with us
                    by nature.
                  </p>
                  ...
                  <p>
                    ...
                    help, create, plan, and execute ideas, which at the end
                    should serve a purpose. Designers are so much more than
                    before, so much more involved in every level of the business
                    and the organization’s body.
                  </p>
                  <p>
                    We often talk about how an organization is like a living
                    organism. Organizations in their core are just like us, they
                    keep growing, changing, and improving for one main reason —
                    to survive. Why do we make these analogies? Why are we
                    looking for ways to compare the human body with the
                    organization’s body? Let’s think about that a bit more by
                    having a proper definition for the human body.
                  </p>
                  <blockquote>
                    <h4>
                  ...
                  <p>
                    The human body consists of biological systems that we can
                    call body systems. Here is a definition of what a body
                    system is:
                  </p>
                  <blockquote>
                    <h4>
                  ...
                  <p>
                    ...
                    combination of different systems and we simply work like
                    that. Think about it… Here are the 10 systems that combined
                    together create the body system (we all know them by heart).
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Digestive system</strong> is the one that takes
                      food and process it to obtain useful nutrients.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      tissues that send out chemical messages — called
                      ‘hormones’ — to the rest of the body.
                    </li>
                    <li>
                      <strong>Nervous system</strong>,allows us to sense stimuli
                      such as light, sound, smell, and touch from our
                      environment.
                    </li>
                    <li>
                      <strong>Musculoskeletal system</strong>,operates to move
                      the organism and stimulate the internal organs.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Reproductive system</strong>, the only system
                      which is not crucial for the survival of the individual,
                      but essential for the survival of the species.
                    </li>
                  </ul>
                  ...
                  <p>
                    ...
                    and how they work together, so you can even read this
                    article. An organization ideally should work the same way in
                    the context of the business and services of course.
                  </p>
                  ...
                  <ul>
                    <li>
                      ...
                      assume a response as any physical or mental act that is
                      done after the signal is sent back. Even scrolling down
                      through the next paragraph of this article requires a
                    ...
                    <li>
                      ...
                      the organization must be connected to all the other parts
                      of the whole. There should be time to review, analyze, and
                  ...
                  <p>
                    So you see this is how we work, we are a chain of systems
                    that work together. Everything in our body is connected and
                    in constant communication. We can say that we try to
                    incorporate everything into our lives with the systematic
                    approach. Humans are designed by systems. The main reason
                    why we approach design so much with systematic thinking
                    nowadays is that organizations become more complex and
                    bigger. It is hard to simplify the processes without the use
                    of systems. This could be our native and organic way of
                    finding a solution in order to communicate with everything.
                    We by nature communicate that way.
                  </p>
                  <p>
                    Let’s try to think about design systems now, and how they
                    fit in the context of the stated above. But first let’s try
                    to give a definition of what a system is.
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      a group of interacting or interrelated entities that form
                      a unified whole
                    ...
                    <li>
                      a cohesive conglomeration of interrelated and
                      interdependent parts that can be natural or human-made.
                  ...
                  <p>
                    So we can see every source has its own way of defining what
                    a system is but in the end, there are a few keywords and one
                  ...
                  <p>
                    ...
                    processes. A design system then should be something to
                    connect and unify the process of creation, delivery and
                    handover of а products or services from a design
                    perspective.
                  </p>
                  <blockquote>
                  ...
                  <p>
                    It’s fundamental to have your whole team on board to follow
                    a systematic way of working. Being a single player in a
                    ...
                    system, but with time this would change and it is changing.
                    We see more and more that companies are looking for a group
                    of people, most of the time a full-blown team, a UX engineer
                    backed up by a team of developers, content writers and
                    business teams such as product owners, marketing teams, etc.
                    working as a single unit in order to communicate and unify
                    the design system experience in the organization.
                  </p>
                  <p>
                    Every person in that scenario has his own expertise, and
                    that is the point of every team. The end goal is the team to
                    be aligned and follow this methodology of working and
                    translate them to other teams. Some will be involved in the
                    way of preparing, some involved in the way of producing, and
                    some involved in the way of presenting.
                  </p>
                  <img src="/defining-design-systems-app-3.jpeg" />
                  <p>
                    We see more and more that this unified approach of having
                    one single source of truth is not very efficient and helpful
                    though. The dream of consistency gets blurred because people
                    still have different needs and fall into different groups.
                    We are constantly talking about different mediums,
                    scenarios, and devices, so this creates an inconsistency of
                  ...
                  <p>
                    ...
                    Spotify Encore solution feels like something that would
                    create a pattern of where design is going. Similar to the
                    statements above, you have one system connected to multiple
                    microsystems that are responsible for their own part and
                    organ.
                  </p>
                  <p>
                    Having one design system which actually works with other
                    small micro-design systems would be the best solution to the
                    many different cases we are trying to cover.
                  </p>
                  ...
                  <p>
                    ...
                    visual design, the code, the process. But then what about
                    some questions that come right away like:
                  </p>
                  <ol>
                  ...
                  <ol>
                    ...
                    <li>
                      Are the designers the ones responsible for the component
                      kit which is actually the design system?
                    </li>
                    <li>
                    ...
                    <li>
                      Does the business and management have a word in that
                      design system?
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    system is, and it will always depend on the organization
                    that you are in. The design system can be that UI kit, these
                    weekly updates, the retro’s you do every sprint, a
                    well-documented website with all components switching
                    smoothly from visuals to code. It can be just the person
                    communicating between the designers and developers in order
                    to create an understanding between them. You should be open
                    and flexible to identify where the need is and to focus to
                    improve it.
                  </p>
                  <p>
                    In the end, it all comes to one thing — it is a process, a
                    service, a way of working that serves to communicate between
                    different team members in order to achieve a better,
                    improved, and stable environment for moving forward. The
                    same as the organization, the design system is a living
                    organism. It can evolve and change in order to survive the
                    never-ending dynamic of the world, but in the end, the core
                    remains. You are just building an interactive or
                  ...
                  <p>
                    ...
                    comprehensive way. So by saying all this we should be able
                    to give a definition for design system:
                  </p>
                  <blockquote>
                    A design system is a collaborative method for the creation
                    of cohesive and consistent solutions related to products and
