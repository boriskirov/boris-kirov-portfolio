        ...
        <main className={`${utilStyles.innerWrapper}`}>
            ...
            <div className={`${utilStyles.contentWrapper}`}>
                <section>
                    ...
                    <h3 className={`${utilStyles.headingL}`}>1. Human by design</h3> 
                    <p>
                    ...
                    <blockquote>
                        <h4><a href="https://www.livescience.com/37009-human-body.html">Human body</a></h4>
                    ...
                    <p>The human body consists of biological systems that we can call body systems. Here is a definition of what a body system is:</p>
                    <blockquote>
                        <h4><a href="https://biologydictionary.net/body-systems/">Body systems</a></h4>
                        Body systems are groups of organs and tissues that work together to perform important jobs for the body.
                    </blockquote>
                    <p>
                    This definition really stuck in my mind. As humans, we are a combination of different systems and we simply work like that. Think about it…
                    Here are the 10 systems that combined together create the body system (we all know them by heart).
                    </p>

                    <ul>
                        <li>
                            <strong>Respiratory system</strong> is the one that takes the oxygen provided by the environment and converts/translates it into a form that our cells can use.
                        </li>
                        <li>
                            <strong>Digestive system</strong> is the one that takes food and process it to obtain useful nutrients.
                        </li>
                        <li>
                            <strong>Cardiovascular/Circulatory system</strong> is the one that provides an efficient way of moving substances around the body. Fun fact: the body’s entire blood takes around a minute to circulate.
                        </li>
                        <li>
                            <strong>Urinary system</strong>,keeps our body healthy, by removing some of the waste that we produce from the digestive system.
                        </li>
                        <li>
                            <strong>Endocrine system</strong>,consists of a number of tissues that send out chemical messages — called ‘hormones’ — to the rest of the body.
                        </li>
                        <li>
                            <strong>Nervous system</strong>,allows us to sense stimuli such as light, sound, smell, and touch from our environment.
                        </li>
                        <li>
                            <strong>Musculoskeletal system</strong>,operates to move the organism and stimulate the internal organs.
                        </li>
                        <li>
                            <strong>Exocrine system</strong>, covers the body and protects it from the outside world, we are talking skin, nails, hair, etc.
                        </li>
                        <li>
                            <strong>Immune system</strong>, we are made from carbs, proteins and lipids, which means that there are other organisms that want to eat us. The immune system helps us fights those unwelcome guests.
                        </li>
                        <li>
                            <strong>Reproductive system</strong>, the only system which is not crucial for the survival of the individual, but essential for the survival of the species.
                        </li> 
                    </ul>
                    ...
                    <h3 className={`${utilStyles.headingL}`}>2. What is a system?</h3> 
                    <p>
                    ...
                    <ul> 
                        <li>
                            ...
                            <a href="https://dictionary.cambridge.org/dictionary/english/system">Cambridge Dictionary</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <a href="https://www.merriam-webster.com/dictionary/system">Merriam Webster Dictionary</a>
                        </li>
                        <li>
                            an assemblage or combination of things or parts forming a complex or unitary whole 
                            <a href="https://www.dictionary.com/browse/system">Dictionary.com</a>
                        </li>
                        <li>
                            a cohesive conglomeration of interrelated and interdependent parts that can be natural or human-made. 
                            <a href="https://en.wikipedia.org/wiki/Systems_theory">Wikipedia System theory definition</a>
                        </li>
                    </ul>
                    ...
                    <h3 className={`${utilStyles.headingL}`}>3. Methods and processes</h3> 
                    <p>
                    ...
                    <h3 className={`${utilStyles.headingL}`}>4. There is one design system in the end</h3> 
                    <p>
                    ...
                    <h3 className={`${utilStyles.headingL}`}>Design system definition</h3> 
                    <p>
                    ...
                    <p>🏴‍☠️ Illustrations done by <a href="https://www.instagram.com/piratejazzy/" target="_blank">Pirate Jazzy</a></p>
