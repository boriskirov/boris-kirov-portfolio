        ...
        <main className={`${utilStyles.innerWrapper}`}>
            ...
            <div className={`${utilStyles.contentWrapper}`}>
                <section>
                    ...
                    <p>
                    <span className={`${utilStyles.dropCap}`}>A</span>t the beginning of August 2016 I lost that extra feature on my palm. The reason for losing the function of a smartphone at this point is irrelevant. My arrogance and eternal curiosity made me take the decision not to fix it, but to start observing what would happen to my fingertips if they were not touching any screen for a while. Participating in this social experiment gave some interesting results and food for thought that I decided to share.
                    </p> 
                    <h3 className={`${utilStyles.headingL}`}>People and our lack of patience</h3>
                    ...
                    <h3 className={`${utilStyles.headingL}`}>How I started to be on point and on time</h3>
                    ...
                    <h3 className={`${utilStyles.headingL}`}>What made my phone return</h3> 
                    ...
                    <h3 className={`${utilStyles.headingL}`}>Is software guilty?</h3>
