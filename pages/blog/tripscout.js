        ...
        <main className={`${utilStyles.innerWrapper}`}>
          ...
          <div className={`${utilStyles.contentWrapper}`}>
            <section>
              ...
              <p>
              <span className={`${utilStyles.dropCap}`}>A</span> while ago me and my teammates at Despark were approached by TripScout to add some new features in their working application. TripScout is a trip application with more than 100,000 users created by exciting people who are eager to travel and learn about new places. 
              </p> 
