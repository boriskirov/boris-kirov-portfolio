...
(Don't get me wrong working in a startup is great, you can check the Tripscout case study to see how the design work can be appreciated and make an impact for the future development of an application.).</p>
              <img src="/nda-app-1.gif"/>
              <h4>2. Get to know your team-mates</h4> 
              <p>Accept that your team-mates are your friends. Would you take it personal if a friend tells you the truth? What about a team-mate saying those designs that you spend like 7 hours twisting and doing the perfect-pixel layout are not worth the work.</p>
              <blockquote>"We can use a component already developed and introduce the change in the application and be done with it."
              </blockquote>
              <p>Yes, it is not serving the perfect design purpose and maybe it is not communicating clearly the end goal but it surely says we got the job done and you can get yours too. With time we will update and improve it. Is the dev team now the design team, are the project managers the product owners and business evangelists now, are they the decision makes now. Who is the decision maker? Why are you spending time working, thinking, talking with everybody involved in the product and at the end, your idea gets shut down? Working on big international software solutions is hard because you hardly see your ideas coming to life. Maybe you can squeeze some motivation and ownership because that primary button change was your idea and now every primary button in the application is blue and it is focusing on the main task of the section or page and it is corresponding to the brand guidelines coming from the marketing team. In a way everybody is happy and you are trying to be happy with them, owning something. </p>
